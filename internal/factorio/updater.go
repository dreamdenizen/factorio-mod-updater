...
func (u *Updater) UpdateMods() (int, error) {
	...
	// We use a context here to guarantee the goroutine is torn down when the function exits,
	// averting memory leaks or hanging channels if the errgroup returns early.
